...
import 'package:tuterritorio/features/submission/presentation/pages/submission_extended/card_extented.dart';
              ...
              child: Row(
                ...
                children: [
                  TextButton.icon(
                      ...
                      label: TextPrimary(text: submission.upVote.toString())),
                  const Spacer(),
                  TextButton.icon(
                      onPressed: () {},
                  ...
                  TextButton.icon(
                      ...
                      label: Text(
                        "Aceptada",
                        style: TextStyle(
                            fontSize: NORMAL_SIZE_TEXT, color: Colors.black),
                      )),
                ],
              ),
            )),
